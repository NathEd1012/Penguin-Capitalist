...
TRAINABLE_PENGUIN4_RSI_PERIOD = 14
TRAINABLE_PENGUIN4_BUY_RSI = 30.0
TRAINABLE_PENGUIN4_SELL_RSI = 70.0
TRAINABLE_PENGUIN4_MAX_CASH_FRACTION = 0.05
TRAINABLE_PENGUIN4_STOP_LOSS_PCT = 0.04
TRAINABLE_PENGUIN4_TAKE_PROFIT_PCT = 0.08
TRAINABLE_PENGUIN4_BB_PERIOD = 20
TRAINABLE_PENGUIN4_BB_STDDEV = 2.0
TRAINABLE_PENGUIN4_ADX_PERIOD = 14
TRAINABLE_PENGUIN4_ADX_THRESHOLD = 25.0
...
class TrainablePenguin4Params:
    ...
    bb_period: int = TRAINABLE_PENGUIN4_BB_PERIOD
    bb_stddev: float = TRAINABLE_PENGUIN4_BB_STDDEV
    adx_period: int = TRAINABLE_PENGUIN4_ADX_PERIOD
    adx_threshold: float = TRAINABLE_PENGUIN4_ADX_THRESHOLD


class TrainablePenguin4(TrainablePenguinCommon):
    LOOKBACK_BARS = 120

    def __init__(self, name: str = "TrainablePenguin4", rsi_period: int = TRAINABLE_PENGUIN4_RSI_PERIOD, buy_rsi: float = TRAINABLE_PENGUIN4_BUY_RSI, sell_rsi: float = TRAINABLE_PENGUIN4_SELL_RSI, max_cash_fraction_per_trade: float = TRAINABLE_PENGUIN4_MAX_CASH_FRACTION, stop_loss_pct: float = TRAINABLE_PENGUIN4_STOP_LOSS_PCT, take_profit_pct: float = TRAINABLE_PENGUIN4_TAKE_PROFIT_PCT, cooldown_bars: int = TRAINABLE_PENGUIN4_COOLDOWN_BARS, bb_period: int = TRAINABLE_PENGUIN4_BB_PERIOD, bb_stddev: float = TRAINABLE_PENGUIN4_BB_STDDEV, adx_period: int = TRAINABLE_PENGUIN4_ADX_PERIOD, adx_threshold: float = TRAINABLE_PENGUIN4_ADX_THRESHOLD):
        super().__init__(name)
...
class TrainablePenguin4_Manual(TrainablePenguin4):
    def __init__(self, name: str = "TrainablePenguin4_Manual", rsi_period: int = 13, buy_rsi: float = 30.0, sell_rsi: float = 70.0, max_cash_fraction_per_trade: float = 0.05, stop_loss_pct: float = 0.04, take_profit_pct: float = 0.08, cooldown_bars: int = 10, bb_period: int = 22, bb_stddev: float = 2.0, adx_period: int = 14, adx_threshold: float = 25.0):
