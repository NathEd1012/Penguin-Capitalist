...
RSI_PERIOD = 27 #13
BUY_RSI = 34.8318 #30.0
SELL_RSI = 68.8442 #70.0
ADX_PERIOD = 21 #14
ADX_THRESHOLD = 27.678 #25.0
MAX_CASH_FRACTION = 0.1657 #0.05
STOP_LOSS_PCT = 0.0106 #0.04
TAKE_PROFIT_PCT = 0.165 #0.08
COOLDOWN_BARS = 22 #10
RELATIVE_STRENGTH_PERIOD = 34 #20
RELATIVE_STRENGTH_THRESHOLD = -0.3195 #0.0
RVOL_PERIOD = 16 #20
RVOL_THRESHOLD = 1.2536 #2.0
...
@dataclass
class ManualTuneAdvSELL_TP1Params:
...
class ManualTuneAdvSELL_TP1(BasePenguin):
    LOOKBACK_BARS = 120
    TRAINABLE = True
    ...
    def __init__(
        ...
        super().__init__(name)
        self.params = ManualTuneAdvSELL_TP1Params(
...
class ManualTuneAdvSELL_TP1_Manual(ManualTuneAdvSELL_TP1):
    TRAINABLE = False
