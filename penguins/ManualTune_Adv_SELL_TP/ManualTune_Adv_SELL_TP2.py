...
BB_STDDEV = 1.9498
ADX_PERIOD = 18
ADX_THRESHOLD = 35.4248
MAX_CASH_FRACTION = 0.1287
STOP_LOSS_PCT = 0.0826
TAKE_PROFIT_PCT = 0.1514
COOLDOWN_BARS = 17
RELATIVE_STRENGTH_PERIOD = 14
RELATIVE_STRENGTH_THRESHOLD = 0.9462
RVOL_PERIOD = 31
RVOL_THRESHOLD = 0.7758
...
@dataclass
class ManualTuneAdvSELL_TP2Params:
...
class ManualTuneAdvSELL_TP2(BasePenguin):
    LOOKBACK_BARS = 120
    TRAINABLE = True
    ...
    def __init__(
        ...
        super().__init__(name)
        self.params = ManualTuneAdvSELL_TP2Params(
            bb_period=bb_period,
            bb_stddev=bb_stddev,
    ...
    def decide(
        ...
        if shares_owned > 0:
            ...
            if (
                ...
                or (upper_band_take_profit and adx_value < self.params.adx_threshold * 0.85)
...
class ManualTuneAdvSELL_TP2_Manual(ManualTuneAdvSELL_TP2):
    TRAINABLE = False
