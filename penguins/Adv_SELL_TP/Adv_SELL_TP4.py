...
BUY_RSI = 25.9945
SELL_RSI = 85.698
MAX_CASH_FRACTION = 0.1898
STOP_LOSS_PCT = 0.0823
TAKE_PROFIT_PCT = 0.1364
COOLDOWN_BARS = 2
RELATIVE_STRENGTH_PERIOD = 38
RELATIVE_STRENGTH_THRESHOLD = 0.3307
RVOL_PERIOD = 13
RVOL_THRESHOLD = 0.9018


@dataclass
class Adv_SELL_TP4Params:
...
class Adv_SELL_TP4(BasePenguin):
	LOOKBACK_BARS = 120
	TRAINABLE = True
...
class Adv_SELL_TP4_Manual(Adv_SELL_TP4):
	LOOKBACK_BARS = 120
	TRAINABLE = False
