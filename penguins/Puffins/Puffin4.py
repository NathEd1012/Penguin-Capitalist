...
class Puffin4Params:
    ...
    trendscore_threshold: float = TRENDSCORE_THRESHOLD
...
class Puffin4(BasePenguin):
    def __init__(
        ...
        self.params = Puffin4Params(
            ...
            trendscore_threshold=trendscore_threshold,
    ...
    def decide(
        ...
        bb_buy_signal = (
            ...
            and trend_score > self.params.trendscore_threshold
        )
        rsi_buy_signal = (
